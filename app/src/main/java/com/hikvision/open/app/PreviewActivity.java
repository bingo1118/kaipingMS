...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener, HikVideoPlayerCallback, TextureView.SurfaceTextureListener {
    ...
    private void getUrl(String contactId) {
        String url="http://134.175.137.26:51091/fireSystem/app/getPreviewUrl?cameraIndexCode="+contactId;
//        RequestQueue mQueue = Volley.newRequestQueue(this);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if(response.getInt("errorCode")==0){
                                previewUri=response.getString("error");
    ...
    private void startRealPlay(SurfaceTexture surface) {
        ...
        new Thread(() -> {
//            mPlayer.startRealPlay(mUri, PreviewActivity.this);
