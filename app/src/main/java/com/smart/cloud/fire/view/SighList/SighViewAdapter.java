...
public class SighViewAdapter extends RecyclerView.Adapter<SighViewAdapter.ViewHolder> {
    ...
    public SighViewAdapter(Context context, List <Photo> list){
        mContext=context;
        mList = list;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sigh_item,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position){
        if(position == mList.size()){
            holder.photo_iv.setImageResource(R.drawable.esign);
