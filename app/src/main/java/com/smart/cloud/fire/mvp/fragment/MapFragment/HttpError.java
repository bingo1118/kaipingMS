...
import com.smart.cloud.fire.activity.Inspection.InspHistory.InspHistoryEntity;
import com.smart.cloud.fire.activity.Inspection.NoticeListActivity.NoticeEntity;
...
public class HttpError<T> {
    ...
    private ArrayList<NoticeEntity> listNotice;
    private ArrayList<InspHistoryEntity> lstRecord;
    ...
    //巡检任务数
    private int todoNum ;
    private int progreaNum;
    private int complishNum;
    ...
    public ArrayList<NoticeEntity> getListNotice() {
        return listNotice;
    }

    public void setListNotice(ArrayList<NoticeEntity> listNotice) {
    ...
    public int getProgreaNum() {
        return progreaNum;
    }

    public void setProgreaNum(int progreaNum) {
        this.progreaNum = progreaNum;
    }

    public int getComplishNum() {
        return complishNum;
    }

    public void setComplishNum(int complishNum) {
        this.complishNum = complishNum;
    }

    public ArrayList<InspHistoryEntity> getLstRecord() {
        return lstRecord;
    }

    public void setLstRecord(ArrayList<InspHistoryEntity> lstRecord) {
