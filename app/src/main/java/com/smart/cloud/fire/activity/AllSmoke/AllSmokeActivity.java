...
//                        case FRAGMENT_ONE:
                            page="1";
                            mvpPresenter.getNeedSmoke(userID, privilege + "", "1",parentId,areaId, shopTypeId,"1");//显示设备。。
                            mvpPresenter.getSmokeSummary(userID,privilege+"",parentId,areaId,shopTypeId,"1");//显示总数。。
                            areaId_1=areaId;//@@9.6
                            parentId_1=parentId;
